...
const requiredFiles = [
  ...
  "docs/heuristic-registry.md",
  "docs/template-source-registry.md",
  "docs/research/product-workflow-lessons.md",
  "docs/research/reference-deck-patterns.md",
  ...
  "scripts/validate-quality-rubric.mjs",
  "scripts/validate-slide-scorecard.mjs",
  "scripts/validate-repair-plan.mjs",
  ...
  "renderers/marp/themes/cobalt-grid-light.css",
  "templates/marp/README.md",
  "templates/marp/pitch-deck.json",
  "templates/marp/vc-seed-deck.json",
  "templates/marp/investor-demo-day-150s.json",
  "templates/marp/hackathon-demo-3min.json",
  "templates/marp/hackathon-finalist-5min.json",
  "templates/marp/executive-decision-deck.json",
  "templates/marp/consulting-recommendation-10slide.json",
  "templates/marp/research-conference-10min.json",
  ...
  "templates/design-contracts/cobalt-grid-light.json",
  "vendor/frontend-slides/NOTICE.md",
  "vendor/frontend-slides/LICENSE",
  ...
  "skills/slide-generator/references/deck-archetypes-and-hooks.md",
  "skills/slide-generator/references/deck-quality-benchmark.md",
  "skills/slide-generator/references/hackathon-intelligence-and-build.md",
  ...
  "skills/slide-generator/references/visual-style-system.md",
  "skills/slide-generator/references/design-contract.md",
  "skills/slide-generator/references/design-quality-gates.md",
  "skills/slide-generator/references/quality-score-loop.md",
  ...
  "design-systems/cobalt-grid-light/DESIGN.md",
  ...
  "examples/source-grounded-demo/work/quality-rubric.json",
  "examples/source-grounded-demo/work/slide-specs.json",
  "examples/style-workbench/index.html",
  "examples/style-workbench/README.md",
  ...
  "tests/fixtures/render-project/work/quality-rubric.json",
  "tests/fixtures/render-project/work/slide-specs.json",
  "tests/fixtures/render-project/qa/slide-scorecard.json",
  "tests/fixtures/render-project/qa/repair-plan.json",
  "tests/fixtures/render-project/qa/score-history.json",
  "evals/evals.json",
...
for (const phrase of [
  ...
  "references/deck-archetypes-and-hooks.md",
  ...
  "references/quality-score-loop.md",
  "No factual claim",
...
for (const theme of [
  ...
  ["renderers/marp/themes/cool-campaign-light.css", "@theme cool-campaign-light"],
  ["renderers/marp/themes/cobalt-grid-light.css", "@theme cobalt-grid-light"]
]) {
